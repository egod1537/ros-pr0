...
#include "my_interfaces/msg/detail/sensor__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const my_interfaces::msg::Sensor & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_interfaces::msg::Sensor & ros_message)
{
  // Member: id
  cdr >> ros_message.id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_interfaces::msg::Sensor;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const my_interfaces::msg::Sensor *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_interfaces::msg::Sensor *>(
    untyped_ros_message);
...
static size_t _Sensor__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Sensor(full_bounded, is_plain, 0);
...
{
  return &my_interfaces::msg::typesupport_fastrtps_cpp::_Sensor__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_interfaces, msg, Sensor)() {
  return &my_interfaces::msg::typesupport_fastrtps_cpp::_Sensor__handle;
}
